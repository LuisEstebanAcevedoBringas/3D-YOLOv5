...
def parse_opt(known=False):
    ...
    # parser.add_argument('--cfg', type=str, default=ROOT /  './models/yolov5s_3D_C3_F.yaml', help='model.yaml path')
    ...
    parser.add_argument('--name', default='yolov5s_3D_C3_F', help='save to project/name')
