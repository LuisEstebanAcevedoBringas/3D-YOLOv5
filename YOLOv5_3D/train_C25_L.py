...
def parse_opt(known=False):
    ...
    parser.add_argument('--name', default='yolov5s_3D_C25_L', help='save to project/name')
    ############################################### YanaiLab config ######################################################
    parser.add_argument('--weights', type=str, default=ROOT / '../yolov5/yolov5s-cls.pt', help='initial weights path')
    parser.add_argument('--cfg', type=str, default=ROOT /  './models/yolov5s_3D_C25_L.yaml', help='model.yaml path')
